...
public final class SpawnedBodyTable extends Table {
  ...
  public IntVector healthsVector() { return healthsVector(new IntVector()); }
  public IntVector healthsVector(IntVector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), bb) : null; }
